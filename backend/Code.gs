...
const LEAD_COLUMNS = [
  ...
  'Asset Type', 'Asset Subtype', 'Beds', 'Baths', 'Sq Ft', 'Seller Reported Sq Ft', 'Acreage', 'Land Zoning',
  'Land Free And Clear', 'Land Willing To Wait For Development',
  ...
  'NOI', 'Commercial Occupancy Status', 'Commercial Occupancy %', 'NOI Research Notes', 'STR NOI', 'Business Revenue', 'Business Earnings Type', 'Business Earnings',
...
function submitLead(body) {
  ...
  appendRowByHeaders(sheet, {
    ...
    'NOI Research Notes': d.noiResearchNotes || '',
