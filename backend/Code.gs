...
const LEAD_COLUMNS = [
  ...
  'Deal Type', 'ARV', 'Asking Price', 'Chase Estimated Value', 'As-Is Value', 'Pictures Link', 'Rehab Estimate', 'Rehab Estimate Low', 'Rehab Estimate High', 'County Assessed Value',
  'CMA Screenshot URLs',
