...
const LEAD_COLUMNS = [
  ...
  'Rent Ready', 'Occupied Status', 'Has Rent Rolls', 'Has P&L', 'Deliverable Vacant', 'Current Lease Term',
...
function submitLead(body) {
  ...
  appendRowByHeaders(sheet, {
    ...
    'ARV': d.arv || '', 'As-Is Value': d.asIsValue || '', 'Pictures Link': d.picturesLink || '',
    ...
    'Rent Ready': d.propertyRentReady || '', 'Occupied Status': d.occupiedStatus || '',
