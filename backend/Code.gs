...
const LEAD_COLUMNS = [
  ...
  'Deal Type', 'ARV', 'Chase Estimated Value', 'As-Is Value', 'Pictures Link', 'Rehab Estimate', 'Rehab Estimate Low', 'Rehab Estimate High', 'County Assessed Value',
  'CMA Screenshot URLs',
...
function submitLead(body) {
  ...
  appendRowByHeaders(sheet, {
    ...
    'ARV': d.arv || '', 'Chase Estimated Value': d.chaseEstimate || '', 'As-Is Value': d.asIsValue || '', 'Pictures Link': d.picturesLink || '',
